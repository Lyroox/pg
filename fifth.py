...
def is_gif(file_name):
    ...
    return header == gif_header1 and header == gif_header2
...
def is_png(file_name):
    ...
    """
    header = read_header(file_name, len(jpeg_header))  # Opraveno na png_header
...
if __name__ == '__main__':
    # přidej try-expect blok, odchyť obecnou vyjímku Exception a vypiš ji
    try:
